...
INCLUDED_TOP_LEVEL = frozenset(['.github', '.gitignore', 'API', 'CONTRIBUTING.md', 'Fixtures', 'LICENSE', 'Package.swift', 'README.md', 'ROADMAP.md', 'SECURITY.md', 'Sources', 'Tests', 'Tools', 'docs', 'scripts'])
