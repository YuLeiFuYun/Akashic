...
SCHEMA_VERSION = 2
IDENTITY_ID = 'AKASHIC-SOURCE-IDENTITY-V2'
COVERAGE_MODE = "explicit-top-level-complete-v2"
INCLUDED_TOP_LEVEL = frozenset(['.github', '.gitignore', 'API', 'CONTRIBUTING.md', 'ConformanceKits', 'Fixtures', 'LICENSE', 'Package.swift', 'README.md', 'ROADMAP.md', 'SECURITY.md', 'Sources', 'Tests', 'Tools', 'docs', 'scripts'])
